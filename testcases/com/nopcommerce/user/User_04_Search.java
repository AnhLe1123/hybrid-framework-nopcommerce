...
public class User_04_Search extends BaseTest {
	...
	String gender, firstName, lastName, dateDOB, monthDOB, yearDOB, emailAddress, companyName, password;
	String searchKeywordNotExist, searchKeywordRelative, searchKeywordAbsolute, advancedSearchKeyword, category, incorrectManufacturer, correctManufacturer;
